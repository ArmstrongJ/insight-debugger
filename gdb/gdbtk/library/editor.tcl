...
namespace eval Editor {
  ...
  proc edit {loc_info} {
    ...
    if {[info exists external_editor_command]} {
        ...
        set newCmd "sfspawn.exe $external_editor_command \"$fileName\" $lineNum"
...
#    set hWin [pref get gdb/editor]
#    if {! [string compare $hWin ""]} {
#      tk_dialog .warn "Edit" "No editor window specified" error 0 Ok
#    }

#    set newCmd "sfspawn.exe $hWin \"$fileName\" $lineNum"
